...
```powershell
Get-Content photoshop_adapter/examples/set-layer-opacity-multiply.jsx -Raw | python photoshop_adapter/photoshop_bridge.py --stdin
```
...
```powershell
Get-Content photoshop_adapter/examples/create-retouch-layer.jsx -Raw | python photoshop_adapter/photoshop_bridge.py --stdin
```
...
```powershell
Get-Content photoshop_adapter/examples/open-liquify.jsx -Raw | python photoshop_adapter/photoshop_bridge.py --stdin
```
