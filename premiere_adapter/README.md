...
Shell
  python premiere_adapter/premiere_bridge.py --stdin
```
...
```powershell
powershell -ExecutionPolicy Bypass -File premiere_adapter/install_cep_bridge.ps1
```
...
```text
premiere_adapter/cep/com.creativeadapters.premiere
```
