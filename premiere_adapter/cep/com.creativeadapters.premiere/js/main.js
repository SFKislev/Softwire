(function () {
  ...
  try {
    evalScript('try { app.setExtensionPersistent("com.creativeadapters.premiere.panel", 1); "ok"; } catch (e) { "persistence unavailable: " + e; }', function () {});
    ...
    function writeSessionFile(port) {
      ...
      fs.writeFileSync(path.join(dir, "premiere.json"), JSON.stringify(session, null, 2), "utf8");
    }
