---
description: Use SoftWire to control running Windows desktop creative and productivity apps through local scripting bridges.
mode: all
permission:
  bash:
    "softwire *": allow
    "python adapters/*_adapter/*_bridge.py *": allow
    "*": ask
---
